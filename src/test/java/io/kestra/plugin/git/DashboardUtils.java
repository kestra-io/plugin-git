...
public class DashboardUtils {
    ...
    public static Dashboard createDashboardWithoutId(DashboardRepositoryInterface dashboardRepositoryInterface, String tenantId, String title) {
        String dashboardSource = """
        title:\s""" + title + """

        description: TEST DASHBOARD WITHOUT ID
        timeWindow:
          default: P30D # P30DT30H
          max: P365D
        ...
        return dashboardRepositoryInterface.save(null, dashboard, dashboardSource);
    }
}
